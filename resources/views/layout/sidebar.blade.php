      ...
      <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <li class="nav-item">
              ...
              <ul id="components-navs" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                  ...
                  <li>
                      <a href="{{ route('category.Garbagecan') }}">
          ...
          <li class="nav-item">
              ...
              <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                  ...
                  <li>
                      <a href="{{ route('products.Garbagecan') }}">
                          <i class="bi bi-circle"></i><span>Thùng Rác</span>
                      </a>
                      </ul>
                  </li>
              ...
              <ul id="components-nav1" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                  <li>
                      <a href="{{ route('products.index') }}">
                          <i class="bi bi-circle"></i><span>Xem Đơn Hàng</span>
                      </a>
                      </ul>
                  </li>
              ...
              <ul id="components-nav2" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                  <li>
                      <a href="{{ route('order.index') }}">
                          <i class="bi bi-circle"></i><span>Xem Danh Sách Khách Hàng</span>
                      </a>
                      </ul>
                  </li>
                        ...
                        <li class="nav-item">
              <a class="nav-link collapsed" data-bs-target="#components-nav2" data-bs-toggle="collapse"
                  href="{{ route('product_code.index') }}">
                  <i class="bi bi-menu-button-wide"></i><span>Mã Sản Phẩm</span><i class="bi bi-chevron-down ms-auto"></i>
              </a>
              <ul id="components-nav2" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                  <li>
                      <a href="{{ route('product_code.index') }}">
                          <i class="bi bi-circle"></i><span>Thêm Mã Sản Phẩm</span>
                      </a>
                      </ul>
                  </li>
